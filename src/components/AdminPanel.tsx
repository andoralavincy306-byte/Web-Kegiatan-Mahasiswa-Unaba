...
export default function AdminPanel({
  ...
  return (
    <div id="admin-dashboard-container" className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 text-left">
      ...
      <div className="flex border-b border-gray-200 mb-6 gap-2 overflow-x-auto whitespace-nowrap pb-1">
        <button
          onClick={() => { setActiveTab('VERIFICATION'); handleCancelEdit(); }}
          className={`px-5 py-3 text-sm font-bold border-b-2 transition-all cursor-pointer flex items-center space-x-2 shrink-0 ${
