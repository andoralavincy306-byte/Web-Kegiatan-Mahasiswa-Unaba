...
import { GraduationCap, Menu, X, User, Home, Calendar, Lock, Award, LogOut } from 'lucide-react';
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight text-univ-blue-800 sm:text-xl">
              UNABA <span className="text-univ-orange-500">Student Portal</span>
            </h1>
        ...
        <div className="hidden lg:flex items-center space-x-3 border-l border-gray-200 pl-4">
          ...
          <div 
            ...
            className="flex cursor-pointer items-center space-x-1.5 rounded-xl bg-slate-50 border border-slate-200 px-2.5 py-1.5 transition-all hover:bg-slate-100"
          ...
          {onLogout && (
            <button
              ...
              className="flex items-center justify-center rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 p-2 transition-all cursor-pointer"
